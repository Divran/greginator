<?php
	$FILE_NAME_WITHOUT_JSON = "2022-12-24_18-24-13";
	$PATH = $FILE_NAME_WITHOUT_JSON . "/";
	...
	if (json_last_error()) {
		...
		//file_put_contents("INDENTED " . $FILE_NAME_WITHOUT_JSON . ".json", json_encode($json,JSON_PRETTY_PRINT));
